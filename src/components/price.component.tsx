...
export const Price = () => {
  return (
    <section className="my-8">
      ...
      <div className="flex flex-col gap-2 items-center mb-6 sm:flex-row sm:flex-wrap sm:justify-center">
        {data.advantage.map((item) => {
          return (
            <div
              className="rounded-[56px] py-2 px-5 w-fit"
              style={{
                background:
                  "linear-gradient(90deg, rgba(57, 73, 171, 0.1) 0%, rgba(129, 69, 220, 0.1) 100%)",
              }}
            >
              <span className="font-medium text-base text-[#3949ab] sm:text-[22px]">
                {item}
              </span>
            </div>
          );
